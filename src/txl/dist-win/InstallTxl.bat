...
if exist %USERPROFILE%\Desktop\Txl105f chdir %USERPROFILE%\Desktop\Txl105f
if exist bin\txl.exe goto gotem
chdir %USERPROFILE%\Desktop\?*-Txl105f\Txl105f
if exist bin\txl.exe goto gotem
echo/
echo Can't find the unzipped TXL distribution folder Desktop\Txl105f\ -
